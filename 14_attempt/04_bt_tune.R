...
# load objects ----
load(here("14_attempt/data_split/my_metrics.rda"))
...
# load data ----
load(here("14_attempt/data_split/asheville_folds.rda"))
load(here("14_attempt/data_split/chicago_folds.rda"))
load(here("14_attempt/data_split/kauai_folds.rda"))
...
write_csv(
  combined_summary, 
  here("14_attempt/results/14a_bt_tuning_summary.csv")
)
...
save(
  ...
  combined_summary,
  bt_grid,
  file = here("14_attempt/results/14a_bt_combined_results.rda")
)