...
# fix outliers (including for price), try catboost, yeojohnson, imputing numeric with knn, address outliers
# don't convert to NA, keep that data. try ACTUALLY doing variable selection
