...
load(here("08_attempt/results/8a_svm_tune.rda"))
...
# best params ---- 
best_params <- select_best(svm_tune, metric = "mae")

# finalize workflow ----
bt_wflow <- extract_workflow(svm_tune)
...
# save out ----
write_csv(bt_submit, here('08_attempt/results/8a_svm_submission.csv'))
